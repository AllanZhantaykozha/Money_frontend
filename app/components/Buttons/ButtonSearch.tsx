...
const ButtonSearch = () => {
  return (
    <div className="cursor-pointer border-2 items-center justify-between px-7 flex border-greenLight rounded-md w-36 h-14 font-bold text-greenLight hover:scale-105 transition-all">
      <svg
