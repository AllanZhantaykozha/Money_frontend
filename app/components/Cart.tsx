...
const Cart = ({ sum, title, isTotal, isIncome, isExpense }: CartProps) => {
  return (
    <div
      className={`${
        isTotal ? "bg-greenDark" : "bg-gray4"
      } rounded-md grid grid-rows-2 w-full h-[140px] text-white p-6`}
    >
      ...
      <div className="font-bold text-3xl">{sum}₸</div>
    </div>
  );
};
